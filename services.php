...
<div class="services-page">
    <div class="header text-center padd">
        ...
        <div class="wow fadeInUp wow-once" data-wow-duration="0.4s" data-wow-delay="0.4s" data-wow-offset="100">
    ...
    <div class="servies padd">
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4 mb-4 wow fadeInUp wow-once" data-wow-duration="0.6s" data-wow-delay="0.6s" data-wow-offset="100">
                    <div class="service">
                        <div class="icon mb-3 d-flex justify-content-center align-items-center" style="background:#bb4dfe">
