...
<div class="${opt.classNames.modalVideo}" tabindex="-1" role="dialog" aria-label="${opt.aria.openMessage}"><div class="${opt.classNames.modalVideoBody}"><div class="${opt.classNames.modalVideoInner}"><div class="${opt.classNames.modalVideoIframeWrap}" style="padding-bottom:'+padding+'"><button class="${opt.classNames.modalVideoCloseBtn} js-modal-video-dismiss-btn" aria-label="${opt.aria.dismissBtnMessage}"></button>
