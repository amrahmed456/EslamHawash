<?php
    ...
    get_header(false,'feedback');

    $cats = new FeedbackModel;
    $cats = $cats->get_message();
            ...
            <div id="kt_customers_table_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer"><div class="table-responsive"><table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_customers_table">
                ...
                <thead>
                    ...
                    <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                        <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_customers_table" rowspan="1" colspan="1" style="width: 125px;" aria-label="Customer Name: activate to sort column ascending">Project</th>
                        <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_customers_table" rowspan="1" colspan="1" style="width: 165.383px;" aria-label="Email: activate to sort column ascending">feedback</th>
                ...
                <tr class="odd">
                        ...
                        <!--begin::Name=-->
                        <td>
                            <a target="_blank" href="../project.php?portfolio=<?php echo $cat['port_id']; ?>">
                        ...
                        <td class="text-end">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                <!--begin::Menu item-->
                            <div class="delete_feedback_btn menu-item px-3" data-id="<?php echo $cat['id']; ?>" data-kt-customer-table-filter="delete_row" data-bs-toggle="modal" data-bs-target="#kt_modal_new_card">
...
<input type="text" name="form_action" value="delete_feedback" hidden />
<input type="text" name="feedback_id" value="" hidden />
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    ...
                    <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px" style="max-height: 268px;">
                        <h2 class="text-center text-danger">Are you sure you want to delete this Feedback ?</h2>
                        <div class="form-group row">
                            ...
                            <div class="text-center pt-15">
                                ...
                                <button type="submit" class="btn btn-danger">
                                    <span class="indicator-label">Delete Feedback</span>
