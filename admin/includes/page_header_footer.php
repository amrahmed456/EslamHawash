<?php
    ...
    function get_header($styles_only = false, $page = ''){
...
<html lang="en">
	<!--begin::Head-->
	<head><base href="">
		<title>AI Design Teams - Admin Dashboard</title>
		<meta name="description" content="" />
		<meta name="viewport" content="width=device-width, initial-scale=1" />
		<meta charset="utf-8" />
		<link rel="shortcut icon" href="../layout/imgs/favicon.webp" />
		<!--begin::Fonts-->
				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
					...
					<div id="kt_header" style="" class="header align-items-stretch">
						...
						<div class="header-brand">
							<!--begin::Logo-->
							<a href="index.php">
								<img alt="Logo" src="../layout/imgs/logo-w.webp" class="h-25px h-lg-25px">
							</a>
							<!--end::Logo-->
							...
							<div class="container-fluid py-6 py-lg-0 d-flex flex-column flex-lg-row align-items-lg-stretch justify-content-lg-between">
								...
								<div class="page-title d-flex flex-column me-5">
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 pt-1">
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-dark"><?php echo $page; ?></li>
										<!--end::Item-->
									</ul>
									<!--end::Breadcrumb-->
								</div>
					...
					<div class="aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y px-2 my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="{default: '#kt_aside_toolbar, #kt_aside_footer', lg: '#kt_header, #kt_aside_toolbar, #kt_aside_footer'}" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="5px" style="height: 382px;">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link <?php echo ($page == '') ? 'active' : '';?>" href="index.php">
								...
								<div class="menu-item">
								<a class="menu-link <?php echo ($page == 'projects') ? 'active' : '';?>" href="projects.php">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/communication/com001.svg-->
											<span class="svg-icon svg-icon-muted svg-icon-2x me-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
								...
								<div class="menu-item">
								<a class="menu-link <?php echo ($page == 'categories') ? 'active' : '';?>" href="categories.php">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/communication/com001.svg-->
											<span class="svg-icon svg-icon-muted svg-icon-2x me-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
								...
								<div class="menu-item">
								<a class="menu-link <?php echo ($page == 'team') ? 'active' : '';?>" href="team.php">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/communication/com001.svg-->
											<span class="svg-icon svg-icon-muted svg-icon-2x me-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
								...
								<div class="menu-item">
								<a class="menu-link <?php echo ($page == 'messages') ? 'active' : '';?>" href="messages.php">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/communication/com001.svg-->
								...
								<div class="menu-item">
								<a class="menu-link <?php echo ($page == 'feedbacks') ? 'active' : '';?>" href="feedbacks.php">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/communication/com001.svg-->
											<span class="svg-icon svg-icon-muted svg-icon-2x me-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
								...
								<div class="menu-item">
								<a class="menu-link <?php echo ($page == 'campaigns') ? 'active' : '';?>" href="campaigns.php">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/communication/com001.svg-->
											<span class="svg-icon svg-icon-2">
												<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
								...
								<div class="menu-item">
								<a class="menu-link <?php echo ($page == 'settings') ? 'active' : '';?>" href="settings.php">
					...
					<div class="aside-footer flex-column-auto py-5" id="kt_aside_footer">
						<a href="signout.php" class="btn btn-danger w-100">
					...
					<div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<div class="text-dark order-2 order-md-1">
								...
								<a href="https:www.facebook.com/amrahmed789" target="_blank" class="text-gray-800 text-hover-primary">Amr Ahmed</a>
							</div>
							<!--end::Copyright-->
							<!--begin::Menu-->
							<ul class="menu menu-gray-600 menu-hover-primary fw-bold order-1">
								<li class="menu-item">
									<a href="../index.php" target="_blank" class="menu-link px-2">Go To Website</a>
								</li>
